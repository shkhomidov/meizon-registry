...
export const api = {
  ...
  adminRevokeToken: (id) => request(`/console/v1/admin/tokens/${encodeURIComponent(id)}/revoke`, { method: 'POST' }),
  adminReinstateToken: (id) => request(`/console/v1/admin/tokens/${encodeURIComponent(id)}/reinstate`, { method: 'POST' }),
  adminDeleteToken: (id) => request(`/console/v1/admin/tokens/${encodeURIComponent(id)}`, { method: 'DELETE' }),
